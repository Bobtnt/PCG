...
//			Zend_Debug::dump($params);
	...
	private function _constructor(){
		...
		$this->_append('if(!'.$this->name.'_manager::$fastMode){');
	...
	private function _footer(){
		...
		$this->_append('}');
		$this->_append('/**');
		$this->_append(' * Convert real field name into property');
		$this->_append(' * @param string $property');
		$this->_append(' * @return string');
		$this->_append(' */');
		$this->_append('public function getPCGFieldMapping($field){');
		$this->_append('if($key = array_search($field, $this->PCGPropertiesMap)){');
		$this->_append('return $this->PCGPropertiesMap[$key];');
		$this->_append('}');
		$this->_append('return false;');
		$this->_append('}');
		$this->_append('/**');
