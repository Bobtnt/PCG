...
if($_POST['Validate']){
	...
	phpClassGenerator::$generateCustomFiles = ($_POST['generateCustomFiles'] ? true : false);
	phpClassGenerator::$generateIndexFiles = ($_POST['generateIndexFiles'] ? true : false);
	phpClassGenerator::$throwExceptionOnUnkownMagicCall = ($_POST['throwExceptionOnUnkownMagicCall'] ? true : false);
